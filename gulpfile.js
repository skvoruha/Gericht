...
//  При подлкючении json ? нужно наверно отклюяить шрифты
const devTasks = gulp.series(gulp.parallel(fonts, gitignore) ,json );

// Основные задачи будем выполнять параллельно после обработки шрифтов
const buildTasks = gulp.series(fonts, js, gulp.parallel(html, css, images, gitignore, json));
